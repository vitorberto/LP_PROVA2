...
public class ConsultaAgendada {
	...
	public ConsultaAgendada() {
		...
		System.out.println("Digite um valor para que este represente o nome do paciente");
		this.nomePaciente = scan.nextLine();

		System.out.println("Digite um valor para que este represente o nome do médico");
