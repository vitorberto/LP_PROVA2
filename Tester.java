...
public class Tester {
	public static void main(String[] args) {
		...
		System.out.println(
				"Iniciando um objeto p1 com o construtor ConsultaAgendada(int h, int mi, int s, int d, int m, int a, String p, String m);");
		System.out.println("Digite um valor inteiro positivo em horas");
		h = scan.nextInt();

		System.out.println("Digite um valor inteiro positivo em minutos");
		mi = scan.nextInt();

		System.out.println("Digite um valor inteiro positivo em segundos");
		s = scan.nextInt();

		System.out.println("Digite um valor inteiro positivo em dias");
		d = scan.nextInt();

		System.out.println("Digite um valor inteiro positivo em meses");
		m = scan.nextInt();

		System.out.println("Digite um valor inteiro positivo em anos");
		a = scan.nextInt();
		scan.nextLine();
		...
		System.out.println("Por favor, digite o nome do medico");
		me = scan.nextLine();
		...
		System.out.println("======================================================================================");
		System.out.println("Exibindo valores de p1\n");
		...
		System.out.println("======================================================================================");
		System.out.println("Exibindo valores de p2\n");
		...
		System.out.println("======================================================================================");
		System.out.println("Alterando os valores de p1");
		...
		System.out.println("======================================================================================");
		System.out.println("Exibindo valores de p1 com valores alterados");
